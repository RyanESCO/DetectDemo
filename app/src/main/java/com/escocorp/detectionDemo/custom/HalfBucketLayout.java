...
public class HalfBucketLayout extends LinearLayout {
    ...
    public HalfBucketLayout(Context context) {
        this(context, null);
    }

    public HalfBucketLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HalfBucketLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public HalfBucketLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        invalidate();
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int sectionHeight = toothHeight+((toothShroudLayout.getChildCount()) * curveAmount);
//        int sectionTop = paddingTop;//bucketTop - Double.valueOf(toothHeight * 0.7).intValue();
        ...
        if (isShovelOperaterLayout){
            ...
            //wingShroudLayout.setRowCount(wingShroudLayout.getChildCount() / 2);
            wingShroudLayout.setRowCount(2);  //set to two rows for demo
